 ...
 * @param {number} options.jsonLimit json size limit, default 1MB
 * @param {number} options.formLimit form size limit, default 56KB
 * @param {number} options.textLimit text size limit, default 56KB
